        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-gutter">
          ...
          >
            ...
            <div className="flex gap-6 mt-stack-md pt-stack-md border-t border-outline-variant/50">
              {/* GitHub Icon */}
              <Link href="https://github.com/Obiwumma" target="_blank" className="text-on-surface-variant hover:text-primary-fixed-dim transition-colors group">
              ...
              {/* LinkedIn Icon */}
              <Link href="http://linkedin.com/in/pascal-obiwumma" target="_blank" className="text-on-surface-variant hover:text-primary-fixed-dim transition-colors group">
                <svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor" className="group-hover:scale-110 transition-transform duration-200">
              ...
              {/* X (Twitter) Icon */}
              <Link href="https://x.com/Pascal_FTM" target="_blank" className="text-on-surface-variant hover:text-primary-fixed-dim transition-colors group">
          ...
          >
            {isSuccess ? (
              // Success State UI
              <div className="bg-surface border border-primary-fixed-dim/30 rounded-xl p-stack-lg flex flex-col items-center justify-center text-center gap-4 shadow-2xl shadow-primary-fixed-dim/5 h-full min-h-75">
