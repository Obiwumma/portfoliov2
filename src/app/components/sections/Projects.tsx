    ...
    <section className="border-t border-outline-variant relative z-10" id="work">
      <div className="max-w-container-max mx-auto px-margin-mobile md:px-gutter py-section-gap grid grid-cols-1 md:grid-cols-12 gap-gutter">
        ...
        <div className="md:col-span-8 grid grid-cols-1 md:grid-cols-2 gap-gutter">
          ...
          >
            {/* Image Container with Cyber Filter */}
            <div className="relative w-full h-48 border-b border-outline-variant overflow-hidden bg-surface-container-lowest">
              <Image 
                ...
                className="w-full h-full object-cover grayscale opacity-40 group-hover:grayscale-0 group-hover:opacity-100 group-hover:scale-105 transition-all duration-700 ease-out"
                fill
              />
              {/* Mint Glow Overlay that fades on hover */}
          ...
          >
            ...
            <div className="p-stack-lg flex flex-col grow relative z-10">
              <div className="mb-stack-lg">
                ...
                <p className="font-body-md text-body-md text-on-surface-variant leading-relaxed">Full-stack social platform emphasizing rapid content delivery and minimalist UI logic.</p>
              </div>
          ...
          >
            ...
            <div className="p-stack-lg flex flex-col grow relative z-10">
              <div className="mb-stack-lg">
                ...
                <p className="font-body-md text-body-md text-on-surface-variant leading-relaxed">Machine learning pipeline utilizing Random Forest for analytics with LIME & SHAP.</p>
              </div>
